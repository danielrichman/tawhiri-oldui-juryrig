...
extern const int axis_1_pressure[];
extern const char *axis_2_variable[];
extern const double axis_3_latitude[];
extern const double axis_4_longitude[];

#endif // TAWHIRI_AXES_H
